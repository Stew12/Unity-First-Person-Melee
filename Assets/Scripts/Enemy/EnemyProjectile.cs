...
public class EnemyProjectile : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        trajectory = new Vector3(transform.forward.x * projectileSpeed * Time.deltaTime, transform.forward.y * projectileSpeed * Time.deltaTime, transform.forward.z *  projectileSpeed * Time.deltaTime);
    }
